      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 sm:mb-16">
          <div className="flex items-center gap-2 mb-2">
            <img src="/assets/brand-logo.png" alt="Brand Logo" className="size-6 rounded-lg border border-[#141414] bg-[#141414] p-0.5 object-contain" />
            <p className="font-display text-xs sm:text-sm font-black tracking-[0.2em] text-[#FF4D00] uppercase">HOW IT WORKS</p>
          </div>
          <h2 className="mt-1 font-display text-4xl sm:text-6xl font-black uppercase tracking-tight text-[#141414]">NO DRAMA. JUST DELIVERY.</h2>
        </div>
