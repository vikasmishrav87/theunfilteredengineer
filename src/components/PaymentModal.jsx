              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 mb-6">
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs sm:text-sm font-bold text-slate-900 group-hover:text-emerald-900 leading-tight">UPI QR Code</span>
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs sm:text-sm font-bold text-slate-900 group-hover:text-slate-950 leading-tight">SBI Bank</span>
