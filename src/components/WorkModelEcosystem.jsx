          ...
          <div className="lg:col-span-7 reveal-on-scroll">
            <div className="bg-white/95 border border-indigo-100 rounded-3xl p-8 shadow-sm">
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
                <a
                  href={`https://wa.me/918369804739?text=Hi,%20I%20reviewed%20the%20${encodeURIComponent(WORK_MODEL_ECOSYSTEM.pillars[activeStep].phase)}%20phase%20and%20want%20to%20deploy%20a%20dedicated%20squad.`}
                  target="_blank"
